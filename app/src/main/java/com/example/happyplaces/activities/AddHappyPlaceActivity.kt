        ...
        when (v!!.id) {
            ...
            R.id.tv_select_current_location -> {
                if (!isLocationEnabled()) {
                    Toast.makeText(this, "Your location provider is turned off. Please turn on location permissions", Toast.LENGTH_SHORT).show()
                    ...
                    Dexter.withActivity(this).withPermissions(
                        ...
                        override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                            if (report!!.areAllPermissionsGranted()) {
                                Toast.makeText(this@AddHappyPlaceActivity, "Location permissions are granted", Toast.LENGTH_SHORT).show()
                            }
                        }
